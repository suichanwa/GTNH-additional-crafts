...
import gtnh_additional_crafts.client.keybind.BottomlessPouchHotkeyHandler;

@SideOnly(Side.CLIENT)
public class ClientProxy extends CommonProxy {

    private ConfigHotkeyHandler configHotkeyHandler;
    private BottomlessPouchHotkeyHandler bottomlessPouchHotkeyHandler;
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        BottomlessPouchHotkeyHandler.registerKeyBinding();
        configHotkeyHandler = new ConfigHotkeyHandler();
        bottomlessPouchHotkeyHandler = new BottomlessPouchHotkeyHandler();
        ...
        FMLCommonHandler.instance()
            .bus()
            .register(bottomlessPouchHotkeyHandler);
    }
