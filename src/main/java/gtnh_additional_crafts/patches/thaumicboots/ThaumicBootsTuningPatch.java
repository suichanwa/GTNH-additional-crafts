...
public final class ThaumicBootsTuningPatch {
    ...
    private ThaumicBootsTuningPatch() {}
    ...
    private static float getVoidwalkerSashSpeedBonus(EntityPlayer player) {
        ...
        return VoidwalkerSashTuningPatch.hasSpeedBoostEnabled(sashStack) ? VOIDWALKER_SASH_SPEED_BONUS : 0.0F;
    }
